---
name: image-skill
description: "Build polished React shadcn/ui frontends from GPT Image design boards. Use when the user wants a new app, dashboard, site, prototype, or UI built from an AI-generated mock: clarify the product, scaffold a fresh React shadcn/ui project, generate and revise a gpt-image-2 design board, extract theme and layout decisions, implement the UI with mock data, and repeatedly verify with Playwright screenshots until desktop and mobile match the approved mock closely."
---

# Image-Led Frontend Build
...
6. Generate the first design board in light mode.
   ...
   - Compare every generated board against the default-style quality gate in `references/visual-style-references.md` before showing it. If surface contrast, shadow quality, spacing, typography, card usage, layout rhythm, or component precision is weaker than that written standard, revise the prompt and regenerate.
